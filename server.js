...
app.post("/api/chat", async (req, res) => {
  ...
  conversationHistory.push({
    role: "user",
    content: "Jawaban atas pertanyaan mahasiswa adalah sebagai berikut " +
      userMessage +
      ". Berikan jawaban edukatif, positif, dan membangun atas pertanyaan dalam maksimal 3 kalimat. Gunakan history pertanyaan untuk menjawab pertanyaan berantai. Jangan mengulang isi jawaban."
  });
